...
class Batch:
    def __init__(self,
        ...
        self.g4macroname = "{}/{}_{}GeV.mac".format(self.data_path, particle, energy)
    ...
    def mkdirs(self):
        print(self.g4macroname)
        os.makedirs(self.data_path[:-5] + "build", exist_ok=True)
        os.makedirs(self.data_path, exist_ok=True)
        os.makedirs(self.steer_path, exist_ok=True)
    ...
    def write_shcondors(self):
        ...
        for it, _ in enumerate(self.jobs_events):
            ...
            with open(condorsh, 'w') as f:
                f.write("#!/bin/bash\n")
                #f.write("/opt/exp_soft/vo.gridcl.fr/singularity/ui_el7\n")
                f.write("source {}/env.sh\n".format(os.getcwd()))
                #f.write("export PATH=$PATH:/home/llr/ilc/boudry/miniconda3/bin/python3\n")
                f.write("cat /etc/system-release\n")
                f.write("g++ -v\n")
