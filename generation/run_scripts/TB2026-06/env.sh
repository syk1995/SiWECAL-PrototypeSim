...
K4_DIR=/cvmfs/sw.hsf.org/key4hep/releases/2026-02-01/x86_64-almalinux9-gcc14.2.0-opt
#Need to overwrite the python path to use the one from key4hep manually
#export PATH=/cvmfs/sw.hsf.org/key4hep/releases/2024-10-03/x86_64-almalinux9-gcc14.2.0-opt/python-venv/1.0-2b64yh/bin:$PATH
export PATH=${K4_DIR}/python-venv/1.0-uab3wy/bin:$PATH
